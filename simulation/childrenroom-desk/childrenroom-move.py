...
def run_kitchen_example(
    ...
    output_dir: str = "/workspace/output/childrenroom_desk_move/3_items/100-119",
):
    """
    Headless EN
    EN3EN prims, EN
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="/workspace/output/childrenroom_desk_move/3_items/100-119", help="Output directory")
