...
# Run with ./python.sh diningroom_remove.py
# Features: randomize specified diningroom prims, place on multiple planes
# Pair differences are expressed via removed targets in Frame A/B
...
def run_diningroom_example(
    ...
    output_dir: str = "/workspace/output/diningroom_remove/3_items",
):
    """
    ...
    # 5. BasicWriter: output to the diningroom remove directory
    ...
    for cam_path in camera_list:
        ...
        for frame_idx in range(total_frames):
            ...
            # Resample the set of prims to remove once per pair (A/B two frames)
        ...
        for idx in range(pair_count):
            ...
            if coord_a_idx < actual_coords and coord_b_idx < actual_coords:
                ...
                for prim_path in selected_paths_for_pair:
                    # remove task: write null for the coordinate of objects hidden in Frame B
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="/workspace/output/diningroom_remove/3_items", help="Output directory")
