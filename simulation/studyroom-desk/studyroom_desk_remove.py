...
def run_kitchen_example(
    ...
    output_dir: str = "/workspace/output/studyroom_desk_remove/4_items",
):
    """
    Headless version of the bedroom scene example
    - origin=False: Frame A randomly places controlled objects within the plane, Frame B hides the sampled objects
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="/workspace/output/studyroom_desk_remove/4_items", help="Output directory")
