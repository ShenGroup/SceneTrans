...
def run_kitchen_example(
    ...
    for cam_path in camera_list:
        ...
        for frame_idx in range(total_frames):
            ...
            # For each pair (A/B two frames), re-sample the prim set to be removed
            ...
            if frame_idx % 2 == 0:
                ...
                # Frame A: first ensure all managed objects are visible, then perform normal randomization
                ...
                # A: use USD API to randomize positions and rotations of all managed objects
                ...
                tracked_paths = list(prim_path_map.keys())
                tracked_prim_map = prim_path_map
                # Frame B: do not move objects anymore, only hide the sampled objects
        ...
        for idx in range(pair_count):
            ...
            if coord_a_idx < actual_coords and coord_b_idx < actual_coords:
                ...
                for prim_path in selected_paths_for_pair:
                    # remove task: hidden objects in Frame B have null coordinates
